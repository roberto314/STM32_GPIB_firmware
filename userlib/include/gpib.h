...
// GPIB Signal Lines
#define DAV  PAL_LINE(GPIOB, 13) // 
#define NRFD PAL_LINE(GPIOB, 10) // 
#define NDAC PAL_LINE(GPIOA, 8)  // 
#define IFC  PAL_LINE(GPIOB, 15) // 
#define SRQ  PAL_LINE(GPIOA, 10) // 
#define ATN  PAL_LINE(GPIOA, 15) // 
#define REN  PAL_LINE(GPIOA, 1)  // 
#define EOI  PAL_LINE(GPIOB, 12) // 
#define DC   PAL_LINE(GPIOA, 9)  // 
#define TEx  PAL_LINE(GPIOC, 15) // 
#define PEx  PAL_LINE(GPIOB, 14) // not conn.
#define SC   PAL_LINE(GPIOC, 14) // 

#define DIO1 PAL_LINE(GPIOB, 0) 
#define DIO2 PAL_LINE(GPIOB, 1) 
#define DIO3 PAL_LINE(GPIOB, 2) 
#define DIO4 PAL_LINE(GPIOB, 3) 
#define DIO5 PAL_LINE(GPIOB, 4) 
#define DIO6 PAL_LINE(GPIOB, 5) 
#define DIO7 PAL_LINE(GPIOB, 6) 
#define DIO8 PAL_LINE(GPIOB, 7) 
